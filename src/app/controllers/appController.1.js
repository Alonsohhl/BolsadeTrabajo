...
//  var PropuestasModel = mongoose.model('propuestas', empSchema);
  var PropuestasModel = require('./db/propuestas.js');
...
controller.insEmp2 = (req, res) => { //Insertar
    ...
    PropuestasModel.findByIdAndUpdate('5bfc522855e3042524bf924e', 
...
controller.insEmp = (req, res) => { //Insertar Empresa
    ...
    var newEmp = new PropuestasModel(req.body);
...
controller.insertProp = (req, res) => { //Insertar
    ...
    PropuestasModel.findByIdAndUpdate({_id: id},function (err,foundObject) {
...
controller.update = (req, res) => { // Actualizar Valor
        ...
        var id=req.params.id;
        PropuestasModel.findOne({_id: id},function (err,foundObject) {
        console.log("Actualizando "+req.body.text);
        if(err){
            console.log(err);
            res.status(500).send();
